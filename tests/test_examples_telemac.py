...
def test_telemac_fzr(telemac_setup):
    ...
    }, varvalues={}, engine="python", calculators="sh:///bin/bash .fz/calculators/Telemac.sh", results_dir="result")
...
def test_telemac_with_aliases(telemac_setup):
    ...
    result = fz.fzr("t2d_breach.cas", "Telemac", varvalues={}, engine="python", calculators="*", results_dir="result")
